...
export default function GeneratorForm() {
    ...
    const handleGenerate = (e: React.FormEvent) => {
        ...
        const payload = {
            url,
            ...(showAdvanced ? selections : {})
        };
        console.log("Sending to Backend:", payload);
    };

    return (
        <form onSubmit={handleGenerate} noValidate className="w-full max-w-full mx-auto flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-700 mt-5 pb-32">

            {/* FIXED: Removed lg:items-stretch and just used items-start so buttons don't stretch */}
            <div className="flex flex-col lg:flex-row gap-4 w-full items-start">
                ...
                <div className="flex flex-col flex-grow w-full gap-2">
                    <div className="relative flex items-center w-full">
                        ...
                        <input
                            ...
                            className="w-full bg-white border border-neutral-300 text-neutral-900 text-base md:text-lg rounded-2xl py-4 pl-12 pr-6 placeholder:text-neutral-400 focus:outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-200 transition-all shadow-sm"
                        />
                    </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto shrink-0">
                    ...
                    <button
                        ...
                        className={`flex-1 lg:flex-none flex items-center justify-center gap-2 border font-medium rounded-2xl px-6 py-4 transition-colors ${
                            isButtonDisabled
                                ...
                                : showAdvanced
                                    ? 'bg-amber-100 border-amber-300 text-amber-900 cursor-pointer'
                    ...
                    <button
                        type="submit"
                        className={`flex-1 lg:flex-none flex items-center justify-center gap-2 font-semibold rounded-2xl px-8 py-4 transition-colors shadow-md ${
                            isButtonDisabled
